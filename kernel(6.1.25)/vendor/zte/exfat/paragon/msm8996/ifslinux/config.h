...
/* Define to 1 if you have the declaration of `bio_get_nr_vecs', and to 0 if
   you don't. */
#define HAVE_DECL_BIO_GET_NR_VECS 1
...
#define HAVE_DECL_FOLLOW_LINK_V1 1
...
#define HAVE_DECL_PUT_LINK_V1 1
...
/* Define to 1 if you have the declaration of `__vfs_write', and to 0 if you
   don't. */
#define HAVE_DECL___VFS_WRITE 0
...
#define HAVE_STRUCT_ADDRESS_SPACE_BACKING_DEV_INFO 1
...
#define HAVE_STRUCT_FILE_F_DENTRY 1
