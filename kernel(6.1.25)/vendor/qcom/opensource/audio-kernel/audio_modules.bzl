...
audio_modules.register(
    ...
    srcs = ["aw882xx/aw882xx.c",
           "aw882xx/aw882xx_bin_parse.c",
           "aw882xx/aw882xx_calib.c",
           "aw882xx/aw882xx_device.c",
           "aw882xx/aw882xx_dsp.c",
           "aw882xx/aw882xx_init.c",
           "aw882xx/aw882xx_monitor.c",
           "aw882xx/aw882xx_spin.c"
    ],
)
audio_modules.register(
    name = "smartpa_stat_dlkm",
    path = DSP_PATH + "/sound",
    srcs = ["smartpa_stat.c"
    ],
)
