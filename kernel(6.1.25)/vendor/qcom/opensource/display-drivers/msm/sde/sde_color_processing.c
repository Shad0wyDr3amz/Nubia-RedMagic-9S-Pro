...
int zte_bypass_dspp_gamut(void *sde_hw_cp_cfg, struct sde_crtc_state *sde_crtc_state)
{
	...
	if (sde_crtc_get_fingerprint_pressed(crtc_state) || sde_crtc_get_fslayer_active(crtc_state)) {
		hw_cfg->payload = NULL;
